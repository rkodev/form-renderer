 ...
 */
class FormElementTextPasswordViewHolder(v: View, listener: FormItemEditTextListener) :
    ...
    init {
        ...
        mEditTextValue.setRawInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD or InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS)
    }
}