 ...
 */
class FormElementTextPhoneViewHolder(v: View, listener: FormItemEditTextListener) :
    ...
    init {
        ...
        mEditTextValue.setRawInputType(InputType.TYPE_CLASS_PHONE or InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS)
    }
}